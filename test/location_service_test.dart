...
void main() {
  group('LocationService Proximity & Geofencing Tests', () {
    ...
    test(
      'calculateDistance correctly measures distance between Siam and Asok',
      () {
    ...
    test(
      'findNearbyStation returns the station if within the strict 50m threshold',
      () {
        final stations = [
          const Station(
            id: 'BTS_CEN',
    ...
    test(
      'findNearbyStation returns null if the position is outside the 50m threshold',
      () {
        final stations = [
          const Station(
            id: 'BTS_CEN',
    ...
    test(
      'getCurrentPosition returns simulated position if mock location provider is set',
      () async {
        final mockPosition = Position(
          latitude: 13.7456,
          longitude: 100.5348,
        ...
        final container = ProviderContainer(
          overrides: [
            mockLocationProvider.overrideWith(
              () => TestLocationNotifier(mockPosition),
            ),
          ],
        );
