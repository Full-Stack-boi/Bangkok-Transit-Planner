...
void main() {
  test('MRT Pink and SRT Red lines are loaded in debug mode', () async {
    ...
    expect(pinkLine, isNotEmpty, reason: 'MRT Pink line should be loaded in debug mode');
    expect(srtRedNorth, isNotEmpty, reason: 'SRT Red North line should be loaded in debug mode');
    expect(srtRedWest, isNotEmpty, reason: 'SRT Red West line should be loaded in debug mode');
    ...
    expect(pk01Exits, isNotEmpty, reason: 'MRT PK01 exits should be loaded in debug mode');
  });
}
